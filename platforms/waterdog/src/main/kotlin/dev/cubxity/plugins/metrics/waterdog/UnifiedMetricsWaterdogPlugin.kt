...
package dev.cubxity.plugins.metrics.waterdog
...
import dev.cubxity.plugins.metrics.waterdog.metric.events.EventsCollection
import dev.cubxity.plugins.metrics.waterdog.metric.server.ServerCollection

class UnifiedMetricsWaterdogPlugin(
    override val bootstrap: UnifiedMetricsWaterdogBootstrap
) : CoreUnifiedMetricsPlugin() {
    override fun registerPlatformService(api: UnifiedMetrics) {
        // WaterdogPE doesn't have a service manager
    }
